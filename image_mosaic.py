...
def resize_and_save_images(parent_folder,image_paths, new_shape):
...
if __name__ == "__main__":
    ...
    for folder in os.listdir(parent_folder):
        ...
        for file in os.listdir(os.path.join(parent_folder,folder)):
            if file.endswith('.jpg') or file.endswith('.png'):
                img_name_list.append(os.path.join(folder,file))
