...
class SiftMatching:
    ...
    def draw_correspondence(self, correspondence, img_1, img_2):
        ...
        for x1, y1, x2, y2 in correspondence:
            ...
            cv2.circle(img_stack, (x1_d, y1_d), radius=self._radius, color=self.BLUE,
                       thickness=self._circ_thickness, lineType=cv2.LINE_AA)

            cv2.circle(img_stack, (x2_d, y2_d), radius=self._radius, color=self.BLUE,
                       thickness=self._circ_thickness, lineType=cv2.LINE_AA)

            cv2.line(img_stack, (x1_d, y1_d), (x2_d, y2_d), color=self.CYAN,
